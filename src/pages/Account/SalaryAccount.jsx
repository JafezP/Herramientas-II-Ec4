      ...
      <div className="grid grid-cols-3 gap-10">
        <div className="w-80 h-70 m-5">
          <div className="p-3 pl-0">
            <h1 className="font-semibold">Cuenta Sueldo</h1>
          </div>
          <div className="border-1 border-gray-200 rounded-md p-4 pb-0 bg-white">
            <h2 className="font-semibold">S/. 2,000.00</h2>
            <p className="text-sm pb-3">Saldo Disponible</p>
            <p className="text-sm">Cta. Sueldo</p>
            <div>
              <span className="text-sm">Scotiabank: </span>
              <span className="text-sm">081-7252241</span>
            </div>
            <div>
              <span className="text-sm">CCI: </span>
              <span className="text-sm">009-555-21289156487-54</span>
            </div>
